...
import 'package:rentify/navigations/updates_navigation.dart';
import 'package:rentify/navigations/wishlists_navigation.dart';
  ...
  Future<bool> _systemBackButtonPressed() async {
    if (_navigatorKeys[_selectedIndex].currentState?.canPop() == true) {
      _navigatorKeys[_selectedIndex].currentState?.pop(
        _navigatorKeys[_selectedIndex].currentContext,
      );
      return false;
    } else {
